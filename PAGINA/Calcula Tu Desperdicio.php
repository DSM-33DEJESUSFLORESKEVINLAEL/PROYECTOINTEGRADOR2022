...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- TITLE OF SITE -->
        <title>Calcula tu desperdicio</title>
		...
		<section class="header">
			<div class="container">	
				...
				<div class="header-right pull-right">
					<ul>
						<!-- pequeño modal -->
						<h2><a href="admin/login.php" >INICIO SESION</a></h2> 
							</li>
					</ul>
				</div>
			</div>	
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<li class="active"><a href="index.php">INICIO</a></li>
								...
								<li><a href="Calcula Tu Desperdicio.php">CALCULA TU DESPERDICIO</a></li>
								<li><a href="ORGANIZA TU NEVERA.php">ORGANIZA TU NEVERA  </a></li>
								<li><a href="tienda.php">CADUCIDAD Y CONSUMO</a></li>
								...
								<div class="row">
									<div class="col-sm-10">
										<div class="single-slide-item-content">
											<h2>Calcula tu desperdicio
											<p>
												Aunque cada día sean pequeñas cantidades ¡todo suma! Si lo multiplicamos por los 365 días del año, la cifra seguro que te sorprende. ¡Descubre tu propio desperdicio, es muy fácil!
											</p>
											<button type="button" class="slide-btn">
												Puedes calcular lo que desperdicias utilizando la guía que ves abajo
											</button>
											<button type="button"  class="slide-btn">
												O puedes utilizar una balanza para pesar lo que desperdicias											</button>
											</button>
											<button type="button"  class="slide-btn">
												Por último, rellena el formulario de esta página y ¡dale a enviar!											</button>
			...
			<div class="container">
				<div class="row">
					<div class="about-us-txt">
						<h2>Guía para estimar el peso de los alimentos</h2>
						<p>
							Si no tienes balanza, aquí tienes la equivalencia en gramos de algunos de los alimentos que más desperdiciamos en casa. Si necesitas buscar otros alimentos, puedes descargarte esta completa GUÍA.						</p>
					</div><!--/.section-header-->
