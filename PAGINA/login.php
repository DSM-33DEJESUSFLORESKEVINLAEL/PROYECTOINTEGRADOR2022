          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">BIENVENIDOS A TECNO-FOODS</h1>
                <?php
$conexion = new mysqli("localhost", "root", "", "mipaginaweb");
...
?>
                ...
                <form class="user" action="index.php" method="POST">
                    ...
                    <button type="submit" name="index_btn" class="btn btn-primary btn-user btn-block"> Login </button>
                    <hr>
